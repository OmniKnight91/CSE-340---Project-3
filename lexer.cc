...
string reserved[] = { "END_OF_FILE",
    "TYPE", "VAR", "IF", "WHILE", "FOR", "SWITCH", "CASE", "DEFAULT", "PRINT", "ARRAY",
    "PLUS", "MINUS", "DIV", "MULT",
    "EQUAL", "COLON", "COMMA", "SEMICOLON",
    "LBRAC", "RBRAC", "LPAREN", "RPAREN", "LBRACE", "RBRACE",
    "NOTEQUAL", "GREATER", "LESS",
    "NUM", "ID", "ERROR", "LTEQ", "REALNUM"
};

#define KEYWORDS_COUNT 14
string keyword[] = { "VAR", "IF", "WHILE", "FOR", "SWITCH", "CASE", "DEFAULT", "print", "ARRAY", "REAL", "INT", "BOOLEAN", "STRING", "LONG" };
